...
public class AddCollegeDialog extends JDialog implements ActionListener{
		...
		try {
			if(e.getSource() == button) {
				if(!text1.getText().equals("") && !text3.getText().equals("")) {
					coll = new College(text1.getText(),text3.getText());
					coll.setHeadName(text2.getText());
					try {
						SQLight_DataBase.addCollege(text3.getText(),text1.getText());
